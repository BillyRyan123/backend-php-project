...
<body>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    ?>
     ...
     <a href="add_vacation.php" class="btn btn-dark mb-3">Add New</a>
            ...
            while($row= mysqli_fetch_assoc($result)){
                ?>
                   <tr>
                    ...
                    <th><?php  echo $row ['vacation_type']?></th>
                    <th><?php  echo $row ['gender']?></th>
                    <td>
                        <a href="edit_vacation.php?id=<?php echo $row['id']?>" class="link-dark"><i class="fa-solid fa-pen-square  fs-5 me-3"></i></a>
                        <a href="delete_vacation.php?id=<?php echo $row['id']?>"class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                    </td>         
                    </tr>
