...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `training`(`id`,`first_name`,`last_name`,`training_type`,`gender`)
    VALUES (NULL,'$first_name','$last_name','$training_type','$gender');";

    $result=mysqli_query($conn , $sql);

    if ($result) {
        header("location../training_table.php?msg=New record created successfully!");
        ...
        <div class="conainer d-flex justify-content-center">
            <form action=""method="post" style="width:50vw; min-width:300px;">
               ...
               <div class="col">
                    ...
                    <input class="form-control" type="text" name="training_type" placeholer="trianing type">
                </div>
               </div>
