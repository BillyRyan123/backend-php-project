...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `add_employee` SET `first_name`='$first_name', `last_name`= '$last_name',`email`='$email',`gender`='$gender' WHERE id=$id";
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-3">
            ...
            <p class="text-muted">Click to update employee information</p>
        </div>

        <?php
          $id=$_GET['id'];
          $sql="SELECT * FROM `add_employee` WHERE id = $id LIMIT 1";
          $result= mysqli_query($conn,$sql);
