...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `vacation`(`id`,`first_name`,`last_name`,`vacation_type`,`gender`)
    VALUES (NULL,'$first_name','$last_name','$vacation_type','$gender');";

    $result=mysqli_query($conn , $sql);

    if ($result) {
        header("location../vacation_table.php?msg=New record created successfully!");
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-3">
            <h3>Add Vacation</h3>
            <p class="text-muted">Complete the form below to add a new vacation</p>
        </div>
        ...
        <div class="conainer d-flex justify-content-center">
            <form action=""method="post" style="width:50vw; min-width:300px;">
               ...
               <div class="mb-3">
               <div class="col">
                    <label class="form-label" for="">Vacation_type</label>
                    <input class="form-control" type="text" name="vacation_type" placeholer="vacation type">
                </div>
               </div>
